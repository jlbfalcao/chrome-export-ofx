...
/***/ function(module, exports, __webpack_require__) {
	...
	function parseItaucardPage() {
	    ...
	    .map(function (_ref) {
	        ...
	        return {
	            date: (0, _parseDate2.default)(date, 'DD/MM', (0, _extraPayments2.default)(description, /(\d+)\/(\d+)/)),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buildTransaction = __webpack_require__(3);

	var _buildTransaction2 = _interopRequireDefault(_buildTransaction);
	...
	exports.default = function (transactions) {
	  return 'OFXHEADER:100\nDATA:OFXSGML\nVERSION:102\nSECURITY:NONE\nENCODING:USASCII\nCHARSET:1252\nCOMPRESSION:NONE\nOLDFILEUID:NONE\nNEWFILEUID:NONE\n\n<OFX>\n<SIGNONMSGSRSV1>\n<SONRS>\n<STATUS>\n<CODE>0\n<SEVERITY>INFO\n</STATUS>\n<DTSERVER>' + (0, _moment2.default)().format('YYYYMMDD') + '100000[-03:EST]\n<LANGUAGE>POR\n</SONRS>\n</SIGNONMSGSRSV1>\n<BANKMSGSRSV1>\n<STMTTRNRS>\n<TRNUID>1001\n<STATUS>\n<CODE>0\n<SEVERITY>INFO\n</STATUS>\n<STMTRS>\n<CURDEF>BRL\n<BANKTRANLIST>\n\n' + transactions.map(_buildTransaction2.default).join("\r\n") + '\n\n</BANKTRANLIST>\n</STMTRS>\n</STMTTRNRS>\n</BANKMSGSRSV1>\n</OFX>';
	};
...
/***/ function(module, exports) {
	...
	exports.default = function (_ref) {
	    ...
	    return ['<STMTTRN>', '<TRNTYPE>' + (value < 0 ? 'DEBIT' : 'CREDIT'), '<DTPOSTED>' + date.format('YYYYMMDD') + '100000[-03:EST]', '<TRNAMT>' + value.toFixed(2), '<MEMO>' + description, '</STMTTRN>'].join("\r\n");
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (date, format) {
	    ...
	    return (0, _moment2.default)(date, format).subtract((0, _moment2.default)(date, format).isAfter() ? 1 : 0, 'year').add(extra, 'months');
	};
